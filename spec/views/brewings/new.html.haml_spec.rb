...
describe "brewings/new.html.haml" do
  before(:each) do
    assign(:brewing, stub_model(Brewing,
      :name => "MyString",
      :notes => "MyText",
      :brew_type_id => 1,
      :kit_name => "MyString"
  ...
  it "renders new brewing form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => brewings_path, :method => "post" do
